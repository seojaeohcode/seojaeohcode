...
- **창업직썰** | 인턴십 (1 month)
- **만들닷** | 취업연계근로진행중 (In Progress)

## 🎓 Education

- **전남대학교 대학원** | 지능형 소프트웨어 진화 & 유지 보수 연구실
- **전남대학교** | 인공지능학부 재학 (AI/Web/Mobile/DevOps) / 지식재산융합학과 (복수전공)
...
| 구분 | 수상 및 활동명 | 비고 |
| :--- | :--- | :--- |
| **전국** | **2026 메가시티리그전 - 한국창업보육협회 회장상** | 2026. 3Q |
...
| **전국** | **서울시 공공데이터 웹앱 경진대회 - 우수상** | Seoul Street Gallery |
| **전국** | **2022 창의적종합설계 경진대회 - 입상** | BlendA 2022 |
| **지역** | **2026 창업드림팀 모의투자 경진대회 - 1등** | 2026. 3Q |
| **지역** | **2026 제품제작역량강화캠프 - 우수상** | 2026. 3Q |
| **지역** | **2026 대학연합창업드림팀 - 우수상** | 2026. 3Q |
| **지역** | **2025 SW중심대학 호남권 LLM 해커톤 - 장려상** | 2025. 3Q |
| **지역** | **광주전남 상표/디자인 경진대회 - 전남테크노파크원장상(2등)** | 2026. 1Q |
| **학회** | **스마트미디어학회 춘계2025 - 우수논문상** | 계층적 생성방식 한국어 제목 생성 |
| **교내** | **2025 AI기반 창업창의력 Jump-UP - 대상(전남대학교 총장상)** | Whooo(후우) |
| **교내** | **SW 창업 최우수상** | SW 동아리 발굴 및 지원프로그램 |
| **교내** | **소프트웨어중심사업단 1차 1등** | 600만원 |
| **교내** | **캡스톤디자인 경진대회 - 금상** | 2025. 3Q |
| **선정** | **모두의창업 1기 선정** |  |
| **선정** | **재정경제부 공공데이터 모니터링단 선정** |  |
...
- **Training**: NHN Cloud 교육, Microsoft 데이터분석 특강, Nvidia CUDA 가속컴퓨팅 수강, K-MOVE 미국 백엔드 개발자 과정 수료, 하나 유니버시티
